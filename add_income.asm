...
section .bss
    ...
    desc_buffer resb 55
    current_amount resb 4   ; stores income amount
...
get_income_amount:
    ...
    ; Convert income string to amount in cents and set decimal flag
...
string_to_cents:
    ; Convert string in income_buffer to cents in eax and set is_decimal
    push ebx
    push ecx
    push edx
    push edi
    ...
    mov ebx, income_buffer  ; pointer to input
